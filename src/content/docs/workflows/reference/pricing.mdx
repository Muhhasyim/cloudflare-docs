...
Cloudflare will not bill step and storage usage before the start date announced in the [Workflows billing changelog](/changelog/post/2026-08-01-workflows-billing-updates/).
...
An instance that attempts to store state when you have reached the storage limit on the Free plan will cause an error to be thrown.
