...
| Storage (GB-mo)     | 1GB                                                                                 | 1 GB included per month + $0.20/ GB-month                                                       |
...
If an instance attempts to store state when you have reached the storage limit on the Free plan, an error will be thrown.
